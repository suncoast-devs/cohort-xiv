...
const yelling = words => words.map(element => element.toUpperCase())
...
const theWayPhilLikesIt = numbers => {
  return numbers.filter(number => number % 2 === 0)
}

const delicious = numbers => numbers.filter(number => number % 2 === 0)

const evens = delicious(['1', '2', '3', 4, 5, 6, 7])
/*
